 ...
 * @example
 *
 *     api.signup('name', 'email', 'username', 'password', function(err, data) {
 *          console.log(data);
 *     });
 *
 * @method signup
...
Ully.prototype.signup = function signup(name, email, username, password, callback) {
    this.post('signup', {
        name: name,
        email: email,
        username: username,
...
Ully.prototype.login = function login(email, password, callback) {
    this.post('forgot/access_token', {
        ...
        if (callback) {
            ...
            //Write config
            if (res.body.response.hasOwnProperty('access_token') && res.body.response.hasOwnProperty('permissions')) {
 ...
 * @example
 *
 *     api.forgot('email', 'username', function(err, data) {
 *          console.log(data);
 *     });
 *
 * @method forgot
...
Ully.prototype.forgot = function forgot(email, username, callback) {
    this.post('forgot', {
        email: email,
        username: username
    }, function(err, res) {
